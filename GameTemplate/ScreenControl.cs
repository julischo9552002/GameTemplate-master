...
namespace GameTemplate
{
    class ScreenControl
    {
        ...
        public static int controlWidth = 1300;
        public static int controlHeight = 900;
        ...
        // button values
        public static Size buttonSize = new Size(200, 80);
        ...
        public static Font buttonFont = new Font("Segoe UI", 15);
